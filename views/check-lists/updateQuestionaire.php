...
?>
        ...
        <div class="col-sm-12 marginTB10 optionstab"
            ...
            <div class="col-sm-8">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="options[]" placeholder="Option" type="text" value="<?php if (!empty($selectedOptions['0'])) {
    echo $selectedOptions['0'];
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="options[]" placeholder="Option" type="text" value="<?php if (!empty($selectedOptions['1'])) {
    echo $selectedOptions['1'];
                ...
                <div class="col-sm-6 margintop10">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="options[]" placeholder="Option" type="text" value="<?php if (!empty($selectedOptions['2'])) {
    echo $selectedOptions['2'];
                ...
                <div class="col-sm-6 margintop10 newcheckbox">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="options[]" placeholder="Option" type="text" value="<?php if (!empty($selectedOptions['3'])) {
    ...
    for ($i = 4; $i < count($selectedOptions); $i++) {
        ?>
                <div class="col-sm-6 margintop10 additional-options">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="options[]" placeholder="Option" type="text" value="<?php if (!empty($selectedOptions[$i])) {
            echo $selectedOptions[$i];
                ...
                <div class="col-lg-12  margintop10">
                    <input class="add-more-button btn btn-success" type="button" name="add_item" value="Add More"
                        id="add">
                    <input class="btn btn-danger remove-item" type="button" id="remove" name="remove_item"
                        value="Remove Option">
                </div>
