...
<div class="col-md-12 col-lg-12 col-sm-12 questionnaire-form">
    ...
    <div class="card fl marginTB10 ">
        ...
        <div class="col-sm-12 margintop10">
            ...
            <div class="col-sm-9 col-lg-9 col-md-9">
                <?= $form->field($model, 'q_section')->widget(Select2::classname(), ['data' => ArrayHelper::map(Sections::find()->where(['is_deleted' => 0,'is_active' => 1])->all(), 'section_id', 's_section_name'), 'language' => 'en', 'options' => ['placeholder' => 'Select Section'], 'pluginOptions' => ['allowClear' => true]])->label(false); ?>
            </div>
        </div>
        <div class="col-sm-12 margintop10">
            <div class="col-sm-3 col-lg-3 col-md-3">
