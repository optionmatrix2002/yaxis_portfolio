...
/* @var $searchModel app\models\SubSectionsSearch */
...
<div class="wa-notification wa-notification-alt">
    ...
    <p id="description-text">
        Master Data of Subsections can be managed from here.
    </p>
</div>
...
<div class="row">
    <div class="col-sm-12 nopadding">
        ...
        <div class="pull-right">
            ...
            {
                ?>
                <a href="<?= yii::$app->urlManager->createUrl('sub-sections/create'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Add Subsection</a>
            <?php }?>
        </div>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model) {
                    return $model->ssSection->s_section_name;
                }
            ],
           /* [
                'attribute' => 'ss_section_id',
            ...
            [
                'attribute' => 'ss_subsection_remarks',
                'format' => 'raw',
                'header' => 'Description',
                'headerOptions' => ['class' => 'theadcolor'],
            ],
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return Html::a('<i class="fa fa-edit"></i>', ['sub-sections/update','id'=>Yii::$app->utils->encryptData($model->sub_section_id)], [
                    ...
                    {
                        return '<a href="javascript:void(0)" title="Delete" class="delete_subsection_btn" data-token ='.yii::$app->utils->encryptData($model->sub_section_id).'><i class="fa fa-trash-o" title="Delete"></i></a>';
                    },
...
<div id="deletepopup" class="modal fade" role="dialog">
    <?php ActiveForm::begin(['id' => 'delete_section_form', 'action' => yii::$app->urlManager->createUrl('sub-sections/delete'), 'method' => 'post',]) ?>
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <input type="hidden" name="deletable_subsection_id" id="deletable_subsection_id" value="" />
                <div class="col-sm-12" style="margin-top: 20px;">
                    <label>
                        Are you sure you want to delete this subsection? You can't undo this action.
                    </label>
                </div>
            </div>
