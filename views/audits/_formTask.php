...
<?php if ($model->isNewRecord) { ?>
    <div class="wa-notification wa-notification-alt">
        ...
        <?php if (!empty($id)) { ?>
            <p id="description-text">Scheduled tasks can be managed or cancelled from here.</p>
        <?php } else { ?>
            <p id="description-text">New Tasks can be scheduled from here.</p>
        <?php } ?>
    </div>
        ...
        <div class="col-sm-12 margintop10">
            ...
            <div class="col-sm-9 col-lg-9 col-md-9">
                <div class="col-sm-6 input-group">
                    <?= Html::a($model->isNewRecord ? 'Save' : 'Update', ['/audits/tasks'], ['class' => 'btn btn-success']); ?>
                    <?= Html::a('Cancel', ['/audits/tasks'], ['class' => 'btn btn-default mg-left-10']); ?>
                </div>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
