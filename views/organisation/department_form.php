...
<div class="col-sm-12">
    ...
    <div class="textField">
        <?= $form->field($departmentModel, 'department_name')->textInput(['maxlength' => 50, 'class' => 'form-control departmentForm  departmentName charsSpecialChars'])->label('Floor Name' . Html::tag('span', '*', ['class' => 'required'])); ?>
...
<div class="textField col-sm-12"
    ...
    <div class="text-center" style="margin-top: 3px;">
        ...
        <button id="add_new_department_cancel_btn" class="btn btn-default" data-dismiss="modal">Cancel</button>
    </div>
</div>
