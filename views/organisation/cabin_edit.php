...
<div class="col-sm-12">
    ...
    <?= $form->field($cabinsModel, 'cabin_name')->textInput(['maxlength' => 50,'class'=>'form-control alphanumeric'])->label('Workspace Name'. Html::tag('span', '*',['class'=>'required'])); ?>
</div>
<div class="col-sm-12">
...
<div class='col-sm-12' style="margin-top: 20px;">
	<div class="col-sm-12 text-center">
		<button id="save_cabin_submit_btn" type="submit"
			class="btn btn-success"><?=$cabinsModel->isNewRecord ? 'Save':'Update'; ?>Workspace</button>
